...
BOT_TOKEN = "6055901899:AAErct6ItHBKD39gtefzC4ZD6GS7YMD9weY"
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5547146074').split()]
